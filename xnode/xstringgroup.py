class XStringGroup:
    separation_method_options = ["none", "newline", "space", "comma", "comma_space", "period", "period_space"]
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "separation_method_1_2": (s.separation_method_options, {"default": "none", "tooltip": "Separation method between String 1 and String 2"}),
                "string_2": ("STRING", {"multiline": True, "default": "", "tooltip": "Second multiline string input"}),
                "separation_method_2_3": (s.separation_method_options, {"default": "none", "tooltip": "Separation method between String 2 and String 3"}),
                "string_3": ("STRING", {"multiline": True, "default": "", "tooltip": "Third multiline string input"}),
                "separation_method_3_4": (s.separation_method_options, {"default": "none", "tooltip": "Separation method between String 3 and String 4"}),
                "string_4": ("STRING", {"multiline": True, "default": "", "tooltip": "Fourth multiline string input"}),
                "separation_method_4_5": (s.separation_method_options, {"default": "none", "tooltip": "Separation method between String 4 and String 5"}),
    ...
    def group_strings(self, select_string, string_1, string_2, string_3, string_4, string_5, separation_method_1_2, separation_method_2_3, separation_method_3_4, separation_method_4_5):
        ...
        grouped_string = string_1 + sm_1_2 + string_2 + sm_2_3 + string_3 + sm_3_4 + string_4 + sm_4_5 + string_5
