...
const Dictionary = {
    'zh': {
        ...
        'lightbox.audio_hint':  '使用播放、波形和音量控件预览音频',
        'lightbox.video_hint':  '使用播放器控件预览视频',
        'lightbox.image_hint':  '滚轮缩放，拖拽平移，双击重置',
        'lightbox.text_hint':   '文本全屏预览',
    ...
    'en': {
        ...
        'lightbox.audio_hint':  'Use playback, waveform, and volume controls to preview audio',
        'lightbox.video_hint':  'Use the player controls to preview video',
        'lightbox.image_hint':  'Use the wheel to zoom, drag to pan, and double-click to reset',
        'lightbox.text_hint':   'Fullscreen text preview',
