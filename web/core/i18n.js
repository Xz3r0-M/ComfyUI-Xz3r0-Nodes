...
const Dictionary = {
    'zh': {
        ...
        'grid.badge.no_preview_tooltip': '此文件已禁用预览功能',
        'grid.badge.unsupported_format_tooltip': '文件编码或格式不受浏览器支持',
        'grid.badge.load_failed_tooltip': '缩略图加载失败，编码或格式可能不兼容',
        ...
        'settings.theme_comfyui':       '跟随 ComfyUI',
        ...
        'settings.canvas_drop_enabled': '拖拽媒体卡片自动创建节点',
        'settings.canvas_drop_enabled_tooltip': '启用：从 XDataHub 拖动媒体卡片（图片 / 视频 / 音频 / 文本）到画布空白处，会自动创建对应的 X*Get 节点并载入该媒体；LoRA 卡片不在处理范围。禁用：仅保留拖到已有节点预览面板载入媒体的旧行为。',
        'settings.sect.thumb_cache':    '缩略图缓存',
        'settings.enable_image_thumb_cache': '图片缓存缩略图',
        'settings.enable_image_thumb_cache_tooltip': '预先生成图片缩略图缓存（缩小+压缩），提升列表浏览流畅度；关闭则直接加载原始文件。',
        'settings.enable_video_thumb_cache': '视频缓存缩略图（需 FFmpeg）',
        'settings.enable_video_thumb_cache_tooltip': '使用 FFmpeg 提取视频首帧作为缩略图缓存；关闭则使用浏览器原生读取。',
        'settings.ffmpeg_not_found':    '未检测到 FFmpeg，视频缩略图功能无法启用',
        'settings.ffmpeg_found':        '已检测到 FFmpeg',
        'settings.clear_thumb_cache_btn': '清除所有缩略图缓存',
        'settings.clear_thumb_cache_btn_tooltip': '删除所有已缓存的缩略图文件，下次浏览时将重新生成',
        'settings.clear_thumb_cache_confirm_title': '确认清除缩略图缓存',
        'settings.clear_thumb_cache_confirm_msg': '将删除所有缩略图缓存文件，此操作不可撤销。确定继续吗？',
        'settings.clear_thumb_cache_cleared': '已清除 {count} 个缩略图文件',
    ...
    'en': {
        ...
        'grid.badge.no_preview_tooltip': 'Preview is disabled for this file',
        'grid.badge.unsupported_format_tooltip': 'File codec or format not supported by the browser',
        'grid.badge.load_failed_tooltip': 'Thumbnail failed to load; codec or format may be incompatible',
        ...
        'settings.theme_comfyui':       'Follow ComfyUI',
        ...
        'settings.default_open_layout.center': 'Centered 75%',
        ...
        'settings.default_open_layout.last': 'Last Position',
        ...
        'settings.canvas_drop_enabled': 'Drag media cards to automatically create nodes',
        'settings.canvas_drop_enabled_tooltip': 'Enabled: dropping an XDataHub media card (image / video / audio / text) onto a blank canvas area auto-creates the matching X*Get node and loads the media. LoRA cards are not handled. Disabled: only dropping onto an existing node preview panel loads the media as before.',
        'settings.sect.thumb_cache':    'Thumbnail Cache',
        'settings.enable_image_thumb_cache': 'Image cached thumbnails',
        'settings.enable_image_thumb_cache_tooltip': 'Pre-generate cached thumbnails for images (resize + compress) to improve grid performance. Disable to load original files directly.',
        'settings.enable_video_thumb_cache': 'Video cached thumbnails (FFmpeg required)',
        'settings.enable_video_thumb_cache_tooltip': 'Use FFmpeg to extract the first frame as a cached thumbnail. Disable to use native browser rendering.',
        'settings.ffmpeg_not_found':    'FFmpeg not found, video thumbnail feature cannot be enabled',
        'settings.ffmpeg_found':        'FFmpeg detected',
        'settings.clear_thumb_cache_btn': 'Clear All Thumbnail Cache',
        'settings.clear_thumb_cache_btn_tooltip': 'Delete all cached thumbnail files. They will be regenerated on next browse.',
        'settings.clear_thumb_cache_confirm_title': 'Clear Thumbnail Cache',
        'settings.clear_thumb_cache_confirm_msg': 'This will delete all cached thumbnail files. This action cannot be undone. Continue?',
